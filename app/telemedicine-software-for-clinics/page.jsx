...
export const metadata = {
  ...
  alternates: {
    canonical: "https://anonsoft.com/telemedicine-software-for-clinics",
  },
  openGraph: {
    title: "White-Label Telemedicine Software for Clinics | Anonsoft",
    description:
    ...
    url: "https://anonsoft.com/telemedicine-software-for-clinics",
    type: "website",
    ...
    <main>
      ...
      <section className="lp-hero">
        ...
        <div className="container">
          ...
          <h1>
            Launch a Branded{" "}
            <span className="gradient-text">Telemedicine Experience</span>
            <br />
            for Your Clinic — In 30 Days
          </h1>
          <p>
            HIPAA-compliant white-label telemedicine software, fully branded
            with your logo and colors, with Epic/Cerner integration built in —
            at up to 70% lower cost than custom development.
          </p>
        ...
        <div className="container">
          ...
          >
            ...
            <h2 className="section-title">
              Custom Telehealth Software for Clinics: Custom vs. Off-The-Shelf
            </h2>
            <p
          ...
          <div style={{ marginTop: "40px", overflowX: "auto" }}>
            ...
            >
              <thead>
                <tr
                  style={{
                    background: "rgba(15, 62, 128, 0.05)",
              ...
              <tbody>
                <tr style={{ borderBottom: "1px solid var(--border-glass)" }}>
                  ...
                  >
                    Vendor owns/hosts your patient records.
                  </td>
                  <td
                    style={{
                      padding: "16px",
                ...
                <tr style={{ borderBottom: "1px solid var(--border-glass)" }}>
                  ...
                  <td
                    style={{ padding: "16px", color: "var(--text-secondary)" }}
                  >
                    Limited to pre-integrated partners.
                  </td>
                  <td
                    style={{
                      padding: "16px",
                ...
                <tr style={{ borderBottom: "1px solid var(--border-glass)" }}>
                  ...
                  <td
                    style={{ padding: "16px", color: "var(--text-secondary)" }}
                  >
                    Rigid layouts, forced workflows.
                  </td>
                  <td
                    style={{
                      padding: "16px",
                ...
                <tr style={{ borderBottom: "1px solid var(--border-glass)" }}>
                  ...
                  <td
                    style={{ padding: "16px", color: "var(--text-secondary)" }}
                  >
                    Typically requires 3-6 months from scratch.
                  </td>
                </tr>
                <tr>
                  <td
                  ...
                  >
                    ...
                    <strong>
                      pre-built, fully customizable white-label telehealth
                      software
                    </strong>{" "}
                    for clinics launched in 30 days.
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      <section className="lp-features">
        <div className="container">
          ...
          >
            ...
            <h2 className="section-title">
              Everything Your Clinic Needs to Go Digital
            </h2>
            <p
              className="section-subtitle"
              style={{ maxWidth: "640px", margin: "12px auto 0" }}
            >
              A complete telemedicine stack, pre-built and compliance-ready — so
              you don't manage 5 different vendors.
            </p>
          </div>
          <div className="lp-features-grid">
            <div className="lp-feature-card">
              ...
              <p>
                Secure, HIPAA-compliant video visits with waiting room,
                recording consent, and mobile-friendly interface for patients
                and providers.
              </p>
            </div>
            <div className="lp-feature-card">
              ...
              <p>
                Connect to Epic, Cerner, Allscripts, or athenahealth via HL7
                FHIR API. Providers see patient history before every visit.
              </p>
            </div>
            <div className="lp-feature-card">
              <div className="lp-feature-icon">💊</div>
              ...
              <p>
                Integrated with Surescripts for controlled and non-controlled
                substance prescriptions sent electronically to any pharmacy.
              </p>
            </div>
            <div className="lp-feature-card">
              <div className="lp-feature-icon">📅</div>
              ...
              <p>
                Multi-provider scheduling with automated appointment reminders
                via SMS/email, self-service booking, and cancellation
                management.
              </p>
            </div>
            <div className="lp-feature-card">
              ...
              <p>
                Stripe and Square payment integration for copays, self-pay, and
                insurance claim data capture. Automated invoicing included.
              </p>
            </div>
            <div className="lp-feature-card">
              <div className="lp-feature-icon">🔒</div>
              ...
              <p>
                AES-256 encryption, audit logging, role-based access control,
                BAA agreements with AWS, and SOC 2 readiness — included at no
                extra cost.
              </p>
            </div>
          </div>
      ...
      <section
        className="lp-features"
        style={{
          background: "rgba(15, 62, 128, 0.01)",
          borderTop: "1px solid var(--border-glass)",
        }}
      >
        <div className="container">
          ...
          >
            ...
            <h2 className="section-title">
              Standalone vs. EHR Integrated Telehealth Solution
            </h2>
            <p
              className="section-subtitle"
              style={{ maxWidth: "640px", margin: "12px auto 0" }}
            >
              Avoid double data entry. Learn how a deeply integrated virtual
              care system saves hours of administrative charting.
            </p>
          </div>
          <div className="lp-features-grid" style={{ marginTop: "40px" }}>
            ...
            <div
              ...
              style={{
                ...
                background: "rgba(39, 193, 156, 0.02)",
              }}
            >
              <h3
                style={{
              ...
              >
                <li>
                  <strong>Auto-Sync Notes</strong>: Clinician charts write
                  directly to the EHR
                </li>
                <li>
                  <strong>Unified Calendar</strong>: Telehealth appointments
                  sync instantly
                </li>
                <li>
                  <strong>Direct Billing</strong>: Claims, CPT codes, and copays
                  transfer seamlessly
                </li>
                <li>
                  <strong>Patient Portal EHR</strong>: Single-sign-on access for
                  patients
                </li>
              </ul>
            </div>
      ...
      >
        <div className="container">
          ...
          >
            ...
            <h2 className="section-title">
              How to Evaluate Telemedicine Software Vendors
            </h2>
            <p
              className="section-subtitle"
              style={{ maxWidth: "640px", margin: "12px auto 0" }}
            >
              Use this 4-point checklist to compare telemedicine vendors and
              secure the best platform for your practice.
            </p>
          </div>
          <div className="lp-features-grid" style={{ marginTop: "40px" }}>
            <div className="lp-feature-card">
              ...
              <p>
                Never rely on verbal compliance. Ensure the vendor signs a
                formal Business Associate Agreement (BAA).{" "}
                <em>
                  Anonsoft is BAA-ready and deploys on your dedicated AWS/Google
                  Cloud instance.
                </em>
              </p>
            </div>
            <div className="lp-feature-card">
              ...
              <p>
                Verify if visit logs, scheduling, and billing codes write back
                directly into Epic, Cerner, or Athenahealth.{" "}
                <em>
                  We provide bi-directional HL7/FHIR integrations to eliminate
                  manual entry.
                </em>
              </p>
            </div>
            <div className="lp-feature-card">
              ...
              <p>
                Ask if you will own the patient data and codebase, or be locked
                into monthly licensing forever.{" "}
                <em>
                  Unlike typical SaaS vendors, we offer full codebase ownership
                  options for your custom platform.
                </em>
              </p>
            </div>
            <div className="lp-feature-card">
              ...
              <p>
                Compare if the vendor supports video, intake forms, scheduling,
                eRx, and payments in one interface.{" "}
                <em>
                  We unify all 5 systems to prevent portal fatigue for patients
                  and staff.
                </em>
              </p>
            </div>
      ...
      <section className="lp-bottom-cta">
        <div className="container">
          ...
          <p>
            Book a free 30-minute consultation. We'll show you the live
            platform, give you a clear cost estimate, and outline exactly how
            fast you can go live — with no obligation and an NDA if needed.
          </p>
          <CalendlyButton

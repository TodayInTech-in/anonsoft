...
let newNav = `        <div class="nav-links" id="navLinks">
          ...
          <a href="" onclick="Calendly.initPopupWidget({url:'https://calendly.com/anonsoftdotin/30min'});return false;" class="nav-cta" id="navCta">Get a Free Session</a>
        </div>`;
...
pages.forEach(page => {
  ...
  let specificHead = headAndNav.replace(/<title>.*?<\/title>/, `<title>${page.charAt(0).toUpperCase() + page.slice(1)} — Anonsoft Software Agency</title>`);
    ...
    if (mainMatch && mainMatch[1].trim() && !mainMatch[1].includes('We are migrating our dedicated')) {
      ...
      <div class="container" style="position: relative; z-index: 2;">
        ...
        <div class="hero-buttons" style="justify-content: center;">
            <a href="" onclick="Calendly.initPopupWidget({url:'https://calendly.com/anonsoftdotin/30min'});return false;" class="btn-primary">

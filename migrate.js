...
let newNav = `        <div class="nav-links" id="navLinks">
          ...
          <a href="" onclick="Calendly.initPopupWidget({url:'https://calendly.com/LaunchHealthApp/30min/'});return false;" class="nav-cta" id="navCta">Get a Free Session</a>
        </div>`;
    ...
    <section class="hero" style="padding-top: 150px; padding-bottom: 80px; min-height: 50vh; display: flex; align-items: center; text-align: center; position: relative;">
      <div class="container" style="position: relative; z-index: 2;">
        ...
        <div class="hero-buttons" style="justify-content: center;">
            <a href="" onclick="Calendly.initPopupWidget({url:'https://calendly.com/LaunchHealthApp/30min/'});return false;" class="btn-primary">
